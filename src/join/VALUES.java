...
public class VALUES implements JoinOperator
{
    ...
    //
    // QueryExecution l_qexec =
    // QueryExecutionFactory.sparqlService(CONSTANTS.L_EP,CONSTANTS.L_QUERY);
    // ResultSet l_results = l_qexec.execSelect();
    //
    // StringBuilder sb = new StringBuilder();
    //
    //
    // HashMap<RDFNode, Set<Binding>> l_solnMap = new HashMap<RDFNode,
    // Set<Binding>>();
    //
    ...
    // QueryExecution r_qexec =
    // QueryExecutionFactory.sparqlService(CONSTANTS.R_EP,QueryFactory.create(query));
    //
    //
    ...
    //
    // log.info("[JOIN] SPARQL1.1_VALUES [RESULTS] "+res.size()+" [TIME]
    // "+(end-start)+" ms");
    //
    // return res;
    // }
    ...
    private void runSingle(SplitQuery sq, List<Var> variables, Query p1,
            Query p2, BenchmarkResult res, boolean debug)
    {
        ...
        QueryExecution p2qexec = (QueryEngineHTTP) QueryExecutionFactory
                .sparqlService(sq.getP2Endpoint().toString(), p2);
        ...
        while (p2_results.hasNext())
        {
            ...
            // Binding bind =
            // Algebra.merge(((ResultBinding)solnp2).getBinding(),
            // ((ResultBinding)solnp2).getBinding());
    ...
    private void runBatch(SplitQuery sq, List<Var> variables, Query p1,
            Query p2, BenchmarkResult res, boolean debug)
    {
        List<Binding> bindings = new ArrayList<Binding>();
        // init execution of left triple pattern
