...
public class Run extends CLIObject
{
    ...
    protected void execute(CommandLine cmd)
    {
        try
        {
            ...
            int batch = Integer.valueOf(cmd.getOptionValue(
                    PARAMETERS.PARAM_BATCHSIZE, "-1"));
            ...
            File outDir, boolean debug, int batch)
    {
        try
        {
            ...
            PrintWriter pwAll = new PrintWriter(new File(outDir, q.getName()
                    + "_results.tsv"));
...
//         "SYMHASHP", 
        ...
        File subQueries = new File(
                "resources/queries/bio/carlos_join1.rq");
